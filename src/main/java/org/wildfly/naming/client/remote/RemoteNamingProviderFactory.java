...
public final class RemoteNamingProviderFactory implements NamingProviderFactory {
    ...
    public RemoteNamingProvider createProvider(final FastHashtable<String, Object> env, final ProviderEnvironment providerEnvironment) throws NamingException {
        return new RemoteNamingProvider(getEndpoint(env), providerEnvironment, env);
    }
